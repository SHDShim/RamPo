...
from ..ds_ramspec import PatternPeakPo
from ..ds_jcpds import JCPDSplt, DiffractionLine
from ..ds_section import Section
from ..ds_ccd import DiffImg


MANIFEST_FILE = "rampo_manifest.json"
SESSION_FILE = "rampo_session.json"
SECTIONS_FILE = "rampo_sections.json"
UI_STATE_FILE = "rampo_ui_state.json"
JCPDS_FILE = "rampo_rapo.json"
BACKUP_INDEX_FILE = "rampo_backup_index.json"

FORMAT_FAMILY = "rampo-session"
FORMAT_VERSION = 1
